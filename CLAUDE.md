...
- **module** (.canductor/templates/module.md): avg 1 cycles, 2 uses — good
- **test** (.canductor/templates/test.md): avg 1 cycles, 3 uses — converged
- **update-exports** (.canductor/templates/module.md): avg 1 cycles, 1 uses — good
